...
<html>
   <head>
      ...
      <style>
         ...
         /*background: #b3c0d0;
*/ 
          background-image: url(<?= base_url('assets/frontent/') ?>assets/image/auth-bg.jpg);
...
label {
   ...
   <body>
      <section class="container">
         <?php $logoImage = check_row('tbl_setting',array('id'=>1)) ;
          ...
          <?php } ?>
         <span class="rig5"><a href="register" class="link2">Try it Free</a></span>
         <span class="rig5">
   ...
   <div class="cont">
      <div class="form-right">
            ...
            <div class="card-body">
              <h2 class="text-center">Forgot Password? Don't worry we all forgot sometime!</h2>
              <form action="<?= base_url('forgot-password') ?>" method="post">
                <div class="row">
                  <div class="col-lg-6 col-sm-6 col-12">
                    <a href="<?= base_url('/') ?>login" class="btn btn-login">Sign in<i id="icon-arrow" class="bx bx-right-arrow-alt"></i></a>
                  </div>

                  <div class="col-lg-6 col-sm-6 col-12">
                    <a href="<?= base_url('/') ?>register" class="btn btn-login">Sign up<i id="icon-arrow" class="bx bx-right-arrow-alt"></i></a>
                  </div>
                </div>
              ...
              <button type="submit" class="btn btn-login">Send Password<i class="fa fa-arrow-right"></i></button>
            </form>
            <hr>
            <div class="text-center"><a href="<?= base_url('login') ?>"><small>I remembered my password</small></a></div>
          </div>
        
      </div>
      <div class="form-left">
        <img src="<?= base_url('assets/frontent/') ?>assets/image/forgottop.png" class="img-responsive">
      </div>
   </div>
</section>
   </body>
