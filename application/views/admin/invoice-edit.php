                       ...
                       <?php endif; ?>
                        <div class="row">
                            ...
                            <div class="col xl9 m8 s12">
                                <div class="card">
                                  <h4 class="admin-heading">Payment Details</h4>
                                    <?php
                              //      print_r($details);
                                    ?>
                                    <div class="card-content invoice-print-area">
                                       ...
                                       <?php echo form_open(base_url('admin/payment/updateInvoice/'.(!empty($details) ? $details->pay_id:'')),'id="edit_payment"'); ?>
                                        ...
                                        <div class="row invoice-info">
                                            ...
                                            <div class="invoice-address">
                                                    <h6 class="invoice-from">Name</h6>
                                                    <span><?= $user->first_name ?? 'Unknow' ?> <?= $user->last_name ?? 'Unknow' ?></span>
                                                </div>
                                            </div>    
                                            <div class="col m6 s12">
                                            ...
                                            <div class="invoice-address">
                                                    ...
                                                    <span><?= $user->full_address ?? 'Unknow' ?></span>
                                                </div>
                                            </div>
                                            <div class="col m6 s12">
                                                
                                            <div class="invoice-address">
                                                    <h6 class="invoice-from">Email</h6>
                                       ...
                                       <div class="col m6 s12">
                                            ...
                                            <div class="invoice-address">
                                                    <h6 class="invoice-from">Package Name</h6>
                                                    <span><?= $details->title ?? 'Unknow' ?></span>
                                                </div>
                                            </div>
                                            <div class="col m6 s12">
                                             <div class="invoice-address">
                                                    <h6 class="invoice-from">Package Amount</h6>
                                                    <span><?= $details->regular_price ?? 'Unknow' ?></span>
                                                </div>
                                            </div>
                                            <div class="col m6 s12">
                                            <div class="invoice-address">
                                                    <h6 class="invoice-from">Transaction ID</h6>
                                                    <span><?= $details->payment_id ?? 'Unknow' ?></span>
                                                </div>
                                            </div>
                                            <div class="col m6 s12">
                                            <div class="invoice-address">
                                                    <h6 class="invoice-from">Payment Type</h6>
                                                    <span><?= strtoupper($details->payment_type) ?? 'Unknow' ?></span>
                                                </div>
                                            </div>
                                            <div class="col m6 s12">
                                            <div class="invoice-address">
                                                    <h6 class="invoice-from">Payment Status</h6>
                                                    <span></span>
                                                    <select name="payment_status">
                                                        <option value="pending" <?php if($details->payment_status=='pending'){ echo 'selected'; }?>>Pending</option>
                                                        <option value="completed" <?php if($details->payment_status=='completed'){ echo 'selected'; }?>>Success</option>
                                                    </select>
...
<input type="hidden" value="<?=$details->title ?>" name="package_title">
<input type="hidden" value="<?=$details->regular_price ?>" name="package_price">
<input type="hidden" value="<?=$details->max_user ?>" name="max_user">
<input type="hidden" value="<?=$details->id ?>" name="package_id">
<input type="hidden" value="<?=$details->valid_for_days ?>" name="valid_for_days">


                                       <button class="btn">Save</button>

                                       <a href="<?= base_url('admin/payment/invoice') ?>" class="btn">Cancel</a>
