...
label {
   ...
   <body>
      <section class="container">
         <a href="<?= base_url('/') ?>" class="signinlogo">TeamifyMe</a>
      ...
      <div class="form-right"> 
            ...
            <div class="card-body">
              ...
              <?php if($this->session->flashdata('message')): ?>
                ...
                ?>
              <form action="<?= base_url('razorpay/checkout/') ?>" method="post">
                <input type="hidden" name="package__ID" value="<?= $_GET['t'] ?>">
                <div class="row">
                ...
                <div class="form-group mb-50">
                  ...
                  <input type="text" name="username" id="username" class="form-control" placeholder="Username" pattern="[^()/><\][\\\x22,;|]+">
                ...
                <div class="form-group mb-50">
                  ...
                  <input type="text" pattern="\d*" maxlength="15" name="phone" class="form-control" placeholder="Phone">
