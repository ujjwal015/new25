            ...
            <div class="card-body">
              ...
              <form action="index.html">
                ...
                <div class="form-group d-flex">
                  <div class="text-left check1">
                    <div class="checkbox checkbox-sm">
                      <input type="checkbox" class="form-check-input" id="exampleCheck1">
                      <label class="checkboxsmall" for="exampleCheck1"><small>Keep me logged in</small></label>
                    </div>
                </div>
                <div class="text-right check2"><a href="forgot-password.html" class="card-link"><small>Forgot Password?</small></a></div>
              </div>
              <button type="submit" class="btn btn-login">Login<i class="fa fa-arrow-right"></i></button>
            </form>
            <hr>
            <div class="text-center"><small class="mr-25">Don't have an account?</small><a href="register.html"><small>Sign up</small></a></div>
          </div>
        
      </div>
      <div class="form-left">
        <img src="<?= base_url('assets/frontent/') ?>assets/image/logintop.png" class="img-responsive">
      </div>
   </div>
</section>
   </body>
