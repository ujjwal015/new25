...

{
    ...
    public function getFeeCollectionReportByFeeType($start_date, $end_date, $feetype_id= null)
    ...
    public function getDiscountCollectionReport($start_date, $end_date, $feetype_id= null,$received_by = null, $group = null)
        ...
        if (!empty($result_value)) {
            ...
            foreach ($result_value as $key => $value) {
                ...
                if ($received_by != null) {
                    ...
                    $return = $this->findDiscountAmountByCollectId($value, $st_date, $ed_date, $received_by);

                } else {



                    $return = $this->findDiscountAmountById($value, $st_date, $ed_date);
    ...
    public function findDiscountAmountById($array, $st_date, $ed_date)

    {
        ...
        for ($i = $st_date; $i <= $ed_date; $i += 86400) {
            ...
            foreach ($ar as $row_key => $row_value) {
                ...
                if ($row_value->date == $find && $row_value->amount_discount!=0) {
    ...
    public function findDiscountAmountByCollectId($array, $st_date, $ed_date, $receivedBy)
        ...
        for ($i = $st_date; $i <= $ed_date; $i += 86400) {
            ...
            foreach ($ar as $row_key => $row_value) {
                ...
                if (isset($row_value->received_by)) {
                    ...
                    if ($row_value->date == $find && $row_value->received_by == $receivedBy && $row_value->amount_discount!=0) {
