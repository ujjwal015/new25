...
class Route extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model(array('api/auth_model', 'api/route_model', 'api/student_model', 'api/setting_model', 'api/attendencetype_model', 'api/studentfeemaster_model', 'api/feediscount_model', 'api/teachersubject_model', 'api/timetable_model', 'api/user_model', 'api/examschedule_model', 'api/grade_model'));
    }
