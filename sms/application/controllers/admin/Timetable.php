...

{
    ...
    public function getallteachertimetable(){
            ...
            foreach ($days as $day_key => $day_value) {
                ...
                $data['timetable'][$day_value] = $this->subjecttimetable_model->getAllByStaffandDay($day_key);

            }


            $timetable_page = $this->load->view('admin/timetable/_getallteachertimetable', $data, true);
