...
class studentidcard extends Admin_Controller {
    ...
    public function create() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (!empty($this->input->post('id_card_width')) && !empty($this->input->post('id_card_height')) ) {

                $id_card_size = $this->input->post('id_card_width').",".$this->input->post('id_card_height');

            }
            if (!empty($this->input->post('photo_width')) && !empty($this->input->post('photo_height')) ) {

                $photo_size = $this->input->post('photo_width').",".$this->input->post('photo_width');

            }
            if (!empty($this->input->post('logo_width')) && !empty($this->input->post('logo_height')) ) {

                $logo_size = $this->input->post('logo_width').",".$this->input->post('logo_height');
