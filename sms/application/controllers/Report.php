...
*/
        ...
        if ($this->form_validation->run() == false) {
            ...
            $params = array('date_from' => $date_from, 'date_to' => $date_to,'invoice_no'=>$invoice_no);
...

    {
       ...
       /* print_r($date_to);die;*/
        ...
        $incomeList = $this->income_model->search("", $start_date, $end_date, $invoice_no);
...
/*
       ...
       /* $start_date = date('Y-m-d', strtotime($dates['from_date']));
        ...
        $expenseList   = $this->expense_model->search("",$start_date, $end_date,$invoice_no);
