                                                    ...
                                                    <div class="btn-group">
                                                      ...
                                                      <div class="pull-right">
                                                        ...
                                                        <button type="button" data-student_session_id="<?php echo $fee->student_session_id; ?>" data-student_fees_master_id="<?php echo $fee->id; ?>" data-fee_groups_feetype_id="<?php echo $fee_value->fee_groups_feetype_id; ?>"
                                                                ...
                                                                title="<?php echo 'Skip Fees'; ?>" data-toggle="modal" data-target="#myFeesSkipModal"
                ...
                <div class="form-horizontal balanceformpopup">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <label for="inputPassword3" class="col-sm-3 control-label"> <?php echo "Colleted By" ?><small class="req"> *</small></label>

                            <div class="col-sm-9">

                                <select class="form-control modal_discount_group" id="collected_by">

                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                    <?php foreach ($staffs as $key => $staff) 
                                        { 
                                            if($staff['role_id']==1 || $staff['role_id']==3 || $staff['role_id']==7){ ?>
                                                <option value="<?php echo $staff['id']; ?>" <?php if($staff_record['id']==$staff['id']) echo "selected"; ?> ><?php echo $staff['name']; ?></option>
                                            <?php 
                                        } 
                                    }?>
...
<div class="modal fade" id="myFeesSkipModal" role="dialog">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb0">
                ...
                <div class="form-horizontal balanceformpopup">
                    ...
                    <div class="box-body">
                        ...
                        <input  type="hidden" class="form-control" id="skip_std_id" value="<?php echo $student["student_session_id"]; ?>" readonly="readonly"/>

                        <input  type="hidden" class="form-control" id="skip_parent_app_key" value="<?php echo $student['parent_app_key'] ?>" readonly="readonly"/>

                        <input  type="hidden" class="form-control" id="skip_guardian_phone" value="<?php echo $student['guardian_phone'] ?>" readonly="readonly"/>

                        <input  type="hidden" class="form-control" id="skip_guardian_email" value="<?php echo $student['guardian_email'] ?>" readonly="readonly"/>

                        <input  type="hidden" class="form-control" id="skip_student_fees_master_id" value="0" readonly="readonly"/>

                        <input  type="hidden" class="form-control" id="skip_fee_groups_feetype_id" value="0" readonly="readonly"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="text" autofocus="" class="form-control modal_amount" id="skip_amount" value="0"  >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <select class="form-control modal_discount_group" id="skip_collected_by">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <textarea class="form-control" rows="3" id="skip_description" placeholder="">Skip Fee</textarea>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn cfees skip_button" id="load" data-action="skip" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"> <?php echo $currency_symbol; ?> <?php echo "Skip Fees"; ?> </button>

                <button type="button" class="btn cfees skip_button" id="load" data-action="print" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"> <?php echo $currency_symbol; ?> <?php echo "Skip". " & " . $this->lang->line('print') ?></button>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.skip_button', function (e) {
        ...
        var student_session_id = $('#skip_std_id').val();

        var amount = $('#skip_amount').val();

        var amount_discount = 0;

        var amount_fine = $('#amount_fine').val();

        var collected_by = $('#skip_collected_by').val();

        var description = $('#skip_description').val();

        var parent_app_key = $('#skip_parent_app_key').val();

        var guardian_phone = $('#skip_guardian_phone').val();

        var guardian_email = $('#skip_guardian_email').val();

        var student_fees_master_id = $('#skip_student_fees_master_id').val();

        var fee_groups_feetype_id = $('#skip_fee_groups_feetype_id').val();
        ...
        $.ajax({
            ...
            url: '<?php echo site_url("studentfee/skipstudentfee") ?>',

            type: 'post',

            data: {action: action, student_session_id: student_session_id, date: date, type: feetype, amount: amount, amount_discount: amount_discount, amount_fine: amount_fine, description: description, student_fees_master_id: student_fees_master_id, fee_groups_feetype_id: fee_groups_feetype_id, guardian_phone: guardian_phone, guardian_email: guardian_email, student_fees_discount_id: student_fees_discount_id, parent_app_key: parent_app_key,collected_by:collected_by},
...
<script type="text/javascript">
    ...
    $("#myFeesSkipModal").on('shown.bs.modal', function (e) {
        ...
        $('#skip_fee_groups_feetype_id').val(fee_groups_feetype_id);

        $('#skip_student_fees_master_id').val(student_fees_master_id);
