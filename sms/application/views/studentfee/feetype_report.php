        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form role="form" action="<?php echo site_url('studentfee/feetype_report') ?>" method="post" class="">
                        <div class="box-body row">
                            <?php echo $this->customlib->getCSRF(); ?>
                            
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                                    <label>Date From</label><small class="req"> *</small></label>
                                    <input name="date_from" id="date_from" placeholder="" type="text" class="form-control date" value="<?php echo date('d.m.Y'); ?>"  />
                                    <span class="text-danger"><?php echo form_error('date_from'); ?></span>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                                    <label>Date To</label><small class="req"> *</small></label>
                                    <input  name="date_to" id="date_to" placeholder="" type="text" class="form-control date" value="<?php echo date('d.m.Y'); ?>"  />
                                    <span class="text-danger"><?php echo form_error('date_to'); ?></span>
                                </div>
                            </div>
                            <div class="col-sm-3 col-lg-3 col-md-3">
                               <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('fees_type'); ?><small class="req"> *</small></label>
   ...
   <?php echo $this->lang->line('no_record_found'); ?>
                    ...
                    <div class="">
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php ?> <?php echo "Specific ". $this->lang->line('fees') . " Type " . $this->lang->line('report'); ?></h3> 
                        </div>
                                        ...
                                        foreach ($results as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td ><table width="100%">
                                                        ...
                                                        <tr>
                                                            <td class="text-left-md"><?php echo getStaff($collect['received_by']); ?>
