        ...
        <div class="box box-primary border0 mb0 margesection">
            ...
            <div class="">
                ...
                <ul class="reportlists">
                    ...
                    if ($this->rbac->hasPrivilege('fee_type', 'can_view')) {
                    ?>
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/feetypereport'); ?>"><a href="<?php echo base_url(); ?>studentfee/feetype_report"><i class="fa fa-file-text-o"></i> <?php echo "Fee Type Report"; ?></a></li>
                    <?php 
                    } 
                   ?>
