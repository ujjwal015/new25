            ...
            <div class="">
                ...
                <ul class="reportlists">
                    ...
                    if ($this->rbac->hasPrivilege('student_attendance_report', 'can_view')) {?>
                        ...
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/attendance/attendance_report'); ?>"><a href="<?php echo base_url(); ?>admin/stuattendence/studentattendencereport"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('student')." ".$this->lang->line('attendance_report'); ?></a></li>

                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/attendance/staff_attendance_report'); ?>"><a href="<?php echo base_url(); ?>admin/staffattendance/staffattendencereport"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('staff')." ".$this->lang->line('attendance_report'); ?></a></li>

                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/student_information/studentpaymentreport'); ?>"><a href="<?php echo site_url('student/paymentreport'); ?>"><i class="fa fa-file-text-o"></i>  <?php echo $this->lang->line('student')." ".$this->lang->line('payment')." ".$this->lang->line('report'); ?></a></li>

                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/student_information/studentdiscountreport'); ?>"><a href="<?php echo site_url('student/discountreport'); ?>"><i class="fa fa-file-text-o"></i>  <?php echo $this->lang->line('student')." ".$this->lang->line('discount')." ".$this->lang->line('report'); ?></a></li>

                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/student_information/studenttransportreport'); ?>"><a href="<?php echo site_url('student/pertransporterreport'); ?>"><i class="fa fa-file-text-o"></i>  <?php echo $this->lang->line('student')." ".$this->lang->line('transport')." ".$this->lang->line('report'); ?></a></li>

                         <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/student_information/studentperareareport'); ?>"><a href="<?php echo site_url('student/studentperareareport'); ?>"><i class="fa fa-file-text-o"></i>  <?php echo $this->lang->line('student')." "."Area ".$this->lang->line('report'); ?></a></li>
