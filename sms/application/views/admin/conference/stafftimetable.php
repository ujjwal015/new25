                                    ...
                                    if (empty($conferences)) {
                                        ...
                                        foreach ($conferences as $conference_key => $conference_value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name" data-sort="<?php echo strtotime($conference_value->date); ?>">
    ...
    <?php 
                                                ...
                                                <td valign="bottom" class="mailbox-date relative text-right" width="90">
                                                    ...
                                                    if ($conference_value->status == 0) {
                                                      ?>
                                                     <a data-placement="left" href="#" class="btn label-success btn-xs start-mr-20" data-toggle="modal" data-target="#modal-chkstatus" data-id="<?php echo $conference_value->id; ?>">
