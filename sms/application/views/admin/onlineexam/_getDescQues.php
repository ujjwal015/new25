...
<button type="submit" class="btn btn-info btn-sm smallbtn28" id="submit" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please wait"><?php echo $this->lang->line('save') ?></button>
</form>
</div>
<div class="col-lg-3 col-md-4 col-sm-12">
  <div class="qbox">
      <ul class="queslist">
        ...
        <li><a href="#"><?php echo $this->lang->line('mobile_no');?><span class="pull-right"><?php echo $result_item->mobileno; ?></span></a></li>
