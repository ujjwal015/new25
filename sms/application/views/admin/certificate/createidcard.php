                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInputEmail1">ID Card size <small>(for horizontal type)</small></label>
                                        <div class="row">
                                            
                                            <div class="col-md-6">
                                                <input id="id_card_width" name="id_card_width" placeholder="width" type="number" class="form-control " value="<?php echo set_value('id_card_width'); ?>"/>
                                            </div>
                                            <div class="col-md-6">
                                                <input id="id_card_height" name="id_card_height" placeholder="height" type="number" class="form-control " value="<?php echo set_value('id_card_height'); ?>"/>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="font_type" name="font_type" placeholder="for header. ex: bold/italic" type="text" class="form-control" value="<?php echo set_value('font_type'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="font_size" name="font_size" placeholder="for header ex: 10" type="number" class="form-control " value="<?php echo set_value('font_size'); ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="font_color" name="font_color" placeholder="for header" type="text" class="form-control my-colorpicker1" value="<?php echo set_value('font_color'); ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="photo_width" name="photo_width" placeholder="width" type="number" class="form-control " value="<?php echo set_value('photo_width'); ?>"/>
                                        </div>
                                        <div class="col-md-6">
                                            <input id="photo_height" name="photo_height" placeholder="height" type="number" class="form-control " value="<?php echo set_value('photo_height'); ?>"/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="logo_width" name="logo_width" placeholder="width" type="number" class="form-control " value="<?php echo set_value('logo_width'); ?>"/>
                                        </div>
                                        <div class="col-md-6">
                                            <input id="logo_height" name="logo_height" placeholder="height" type="number" class="form-control " value="<?php echo set_value('logo_height'); ?>"/>
                                        </div>
                                    </div>
