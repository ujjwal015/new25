                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" enctype="multipart/form-data" action="<?php echo site_url('admin/studentidcard/edit/') . $editidcard[0]->id ?>"  id="certificateform" name="certificateform" method="post" accept-charset="utf-8">
                            ...
                            <div class="box-body">
                                ...
                                $id_card_size=explode(',',$editidcard[0]->id_card_size);
                                $logo_size=explode(',',$editidcard[0]->logo_size);
                                $photo_size=explode(',',$editidcard[0]->photo_size);
                                ?>                                
                                ...
                                <?php if(($editidcard[0]->enable_vertical_card) !=1){?>
                                    <div class="form-group">

                                        <label for="exampleInputEmail1">ID Card size</label>
                                        <div class="row">
                                            
                                            <div class="col-md-6">
                                                <input id="id_card_width" name="id_card_width" placeholder="width" type="number" class="form-control " value="<?php echo set_value('id_card_width', $id_card_size[0]); ?>"/>
                                            </div>
                                            <div class="col-md-6">
                                                <input id="id_card_height" name="id_card_height" placeholder="height" type="number" class="form-control " value="<?php echo set_value('id_card_height', $id_card_size[1]); ?>"/>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="exampleInputEmail1">Font Type</label>

                                    <input id="font_type" name="font_type" placeholder="for header. ex: bold/italic" type="text" class="form-control" value="<?php echo set_value('font_type', $editidcard[0]->font_type); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="font_size" name="font_size" placeholder="for header ex: 10" type="number" class="form-control " value="<?php echo set_value('font_size', $editidcard[0]->font_size); ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="font_color" name="font_color" placeholder="for header" type="text" class="form-control my-colorpicker1" value="<?php echo set_value('font_color', $editidcard[0]->font_color); ?>"/>

                                </div>
                                <div class="form-group">

                                    <label for="exampleInputEmail1">Photo size</label>
                                    <div class="row">
                                        
                                        <div class="col-md-6">
                                            <input id="photo_width" name="photo_width" placeholder="width" type="number" class="form-control " value="<?php echo set_value('photo_width', $photo_size[0]); ?>"/>
                                        </div>
                                        <div class="col-md-6">
                                            <input id="photo_height" name="photo_height" placeholder="height" type="number" class="form-control " value="<?php echo set_value('photo_height',$photo_size[1]); ?>"/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="exampleInputEmail1">Logo size</label>
                                    <div class="row">
                                        
                                        <div class="col-md-6">
                                            <input id="logo_width" name="logo_width" placeholder="width" type="number" class="form-control " value="<?php echo set_value('logo_width',$logo_size[0]); ?>"/>
                                        </div>
                                        <div class="col-md-6">
                                            <input id="logo_height" name="logo_height" placeholder="height" type="number" class="form-control " value="<?php echo set_value('logo_height',$logo_size[1]); ?>"/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <label><?php echo $this->lang->line('vertical').' '.$this->lang->line('design').' '.$this->lang->line('type'); ?></label>
                                            ...
                                            foreach ($idcardlist as $idcard) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="mailbox-date pull-right no-print">
                                                        ...
                                                        <a data-placement="left" data-id="<?php echo $idcard->id ?>" class="btn btn-default btn-xs view_data" data-toggle="tooltip" title="<?php echo $this->lang->line('view'); ?>">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
          ...
          $("#header_color, #font_color").colorpicker();
