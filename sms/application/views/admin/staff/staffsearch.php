...
<?php echo $this->customlib->getCSRF(); ?>
                ...
                if (isset($resultlist)) {
                    ...
                    ?>
                    <form method="post" action="<?php echo base_url('admin/staff/printmultiple') ?>">
                    <div class="box-header ptbnull"></div>  
                    <div class="box-header ptbnull">
                        <button  class="btn btn-primary pull-right btn-sm checkbox-toggle printSelected" style="display: none;" type="button" name="generate" title="generate multiple certificate"><?php echo $this->lang->line('print'); ?> <?php echo $this->lang->line('selected'); ?></button>
                    </div>
                    ...
                    <div class="nav-tabs-custom border0">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active" id="card_view"><a href="#tab_1" data-toggle="tab" aria-expanded="false"><i class="fa fa-newspaper-o"></i> <?php echo $this->lang->line('card'); ?> <?php echo $this->lang->line('view'); ?></a></li>

                            <li class="" id="list_view"><a href="#tab_2" data-toggle="tab" aria-expanded="true"><i class="fa fa-list"></i> <?php echo $this->lang->line('list'); ?>  <?php echo $this->lang->line('view'); ?></a></li>
                                        ...
                                        if (empty($resultlist)) {
                                            ...
                                            foreach ($resultlist as $staff) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" class="checkbox center-block" data-staff_id="<?php echo $staff['id'] ?>"  name="check" id="check" value="<?php echo $staff['id'] ?>">
    ...
    $(document).ready(function () {
        $(document).on('click', '.printSelected', function () {
            ...
            if (array_to_print.length == 0) {
                ...
                $.ajax({
                    url: '<?php echo site_url("admin/staff/printmultiple") ?>',
                    type: 'post',
                    dataType: "html",
