...
if ($this->rbac->hasPrivilege('disable_student', 'can_view')) {
    ...
    ?>
     ...
     <li class="pull-right">
                                    ...
                                    <a href="<?php echo site_url('studentfee/addfee/' . $student["id"]) ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('collect_fees'); ?>"><i class="fa fa-dollar"></i>
...
?>
    ...
    ?>
                            ...
                            <div class="tshadow mb25  bozero">
                                ...
                                <h3 class="pagetitleh2"><?php echo "Change ".$this->lang->line('route') ?></h3>

                                <div class="table-responsive around10 pt0">
                                    <form action="<?php echo site_url('student/updateRoute') ?>"  method="post" accept-charset="utf-8">
                                        <div class="row">
                                            <input type="hidden" name="student_id" id="student_id" value="<?php echo $student["id"]; ?>">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('route')." ".$this->lang->line('list'); ?></label>
                                            ...
                                            <div class="col-md-3">    
                                                <div class="form-group">
                                                    ...
                                                    <button type="submit" class="btn btn-primary pull-right"><?php echo $this->lang->line('update'); ?></button> 
                                                </div>   
                                            </div>
                                        </div>
                                    </form>
